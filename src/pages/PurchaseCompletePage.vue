...
.purchase-item-card.themed-item-card.game-fortnite:hover {
  background-color: rgba(var(--fn-card-bg-opaque-rgb, 25, 15, 50), 0.9);
  border-color: var(--fn-glow-accent, #00ffff);
  box-shadow: 0 0 12px rgba(var(--fn-glow-accent-rgb, 0, 255, 255), 0.5);
}

/* Call of Duty Purchase Item Card Hover */
.purchase-item-card.themed-item-card.game-cod:hover {
  background-color: rgba(var(--cod-card-bg-opaque-rgb, 28, 32, 28), 0.9);
  border-color: var(--cod-glow-accent, #f0e68c);
  box-shadow: 0 0 12px rgba(var(--cod-glow-accent-rgb, 240, 230, 140), 0.5);
}
